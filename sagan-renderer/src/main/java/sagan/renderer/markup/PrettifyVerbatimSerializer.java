 ...
 * It is quite similar to the {@link org.pegdown.DefaultVerbatimSerializer},
 * but prints an additional {@code class="prettyprint"} HTML attribute
 * in order to trigger the JavaScript google-code-prettify library.
 */
