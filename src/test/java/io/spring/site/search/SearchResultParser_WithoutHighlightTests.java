...
import io.spring.site.search.SearchResultParser;
...
public class SearchResultParser_WithoutHighlightTests {
	...
	private static String RESULT_STRING = "{\n" +
			...
			"      \"_score\": 6.519557,\n" +
			"      \"_source\": {\n" +
			"        \"path\": \"http://docs.springframework.io/spring/docs/3.1.4.RELEASE/javadoc-api/org/springframework/context/ApplicationContext.html\",\n" +
	...
	@Test
	public void url() {
		assertThat(content.get(0).getPath(), equalTo("http://docs.springframework.io/spring/docs/3.1.4.RELEASE/javadoc-api/org/springframework/context/ApplicationContext.html"));
	}
