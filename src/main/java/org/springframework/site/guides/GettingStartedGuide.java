...
public class GettingStartedGuide {
	...
	private final static String CI_STATUS_URL = "https://drone.io/github.com/springframework-meta/gs-%s/status.png";
	...
	public String getCiStatusUrl() {
		return String.format(CI_STATUS_URL, guideId);
	}
