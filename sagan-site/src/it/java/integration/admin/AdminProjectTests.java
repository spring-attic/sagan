...
public class AdminProjectTests extends AbstractIntegrationTests {
    ...
    public void saveProjectCustomArtifactId() throws Exception {
        MockHttpServletRequestBuilder request
                ...
                .param("projectReleases[0].refDocUrl", "http://docs.spring.io/spring-data/jdbc/docs/{version}/reference/html")
                .param("projectReleases[0].apiDocUrl", "http://docs.spring.io/spring-data/jdbc/docs/{version}/api/");
