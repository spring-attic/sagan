...
public class BlogFeedController {
    ...
    public String listPublishedPostsForCategory(@PathVariable PostCategory category, Model model, HttpServletResponse response) {
    ...
    private String renderBlogFeeds(Model model, Page<Post> page, String category, String subPath, HttpServletResponse response) {
