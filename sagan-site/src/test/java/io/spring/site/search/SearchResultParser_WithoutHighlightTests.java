...
public class SearchResultParser_WithoutHighlightTests {
    ...
    @Test
    public void url() {
        assertThat(content.get(0).getPath(), equalTo("http://docs.spring.io/spring/docs/3.1.4.RELEASE/javadoc-api/org/springframework/context/ApplicationContext.html"));
    }
