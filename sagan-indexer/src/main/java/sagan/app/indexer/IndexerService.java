...
public class IndexerService {
    ...
    public <T> void index(final Indexer<T> indexer) {
            ...
            this.executorService.submit(new Runnable() {
                ...
                public void run() {
                    try {
                        ...
                        IndexerService.this.countersService.increment("search.indexes." + indexer.counterName()
                                + ".processed");
                    } catch (Exception e) {
                        String message =
        ...
        this.countersService.increment("search.indexes." + indexer.counterName() + ".refresh.count");
    }
}
