...
insert into project values('spring-cloud','Spring Cloud','http://github.com/spring-projects/spring-cloud','active','http://projects.spring.io/spring-cloud','spring-cloud', '', '', '', '', NULL, 5, 'cloud');
insert into project values('spring-cloud-aws','Spring Cloud for Amazon Web Services','http://github.com/spring-cloud/spring-cloud-aws','community','http://cloud.spring.io/spring-cloud-aws','', '', '', '', '', 'spring-cloud', 5, 'cloud');
...
insert into project values('spring-cloud-stream','Spring Cloud Stream','http://github.com/spring-cloud/spring-cloud-stream','active','http://cloud.spring.io/spring-cloud-stream','spring-cloud-stream', '', '', '', '', 'spring-cloud', 5, 'cloud,streams');
insert into project values('spring-cloud-stream-app-starters','Spring Cloud Stream App Starters','http://github.com/spring-cloud/spring-cloud-stream-app-starters','active','http://cloud.spring.io/spring-cloud-stream-app-starters','', '', '', '', '', 'spring-cloud', 5, 'cloud,streams');
