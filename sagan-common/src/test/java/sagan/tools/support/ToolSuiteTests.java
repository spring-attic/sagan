...
public class ToolSuiteTests {
    ...
    private ToolSuiteDownloads buildToolSuite() {
        ...
        v4Mac64Links.add(new DownloadLink("http://example.com/v4_download64.tar.gz", "tar.gz", "323MB", os,
                architecture));
        ...
        v4Mac32Links.add(new DownloadLink("http://example.com/v4_download32.tar.gz", "tar.gz", "323MB", os,
                architecture));
        ...
        architecture = "64";
        v3Mac64Links.add(new DownloadLink("http://example.com/v3_download64.tar.gz", "tar.gz", "323MB", os,
                architecture));
        ...
        v3Mac32Links.add(new DownloadLink("http://example.com/v3_download32.tar.gz", "tar.gz", "323MB", os,
                architecture));
        ...
        platforms.put("windows", new ToolSuitePlatform("Windows", Collections.singletonList(new EclipseVersion("4.3",
                winArchitectures))));
        ...
        architecture = "64";
        linux64Links
                .add(new DownloadLink("http://example.com/linux-x86_64.tar.gz", "tar.gz", "323MB", os, architecture));
