...
public class ToolSuiteTests {
    ...
    public void testPreferredDownloadLinks() throws Exception {
        ...
        links.add(new DownloadLink("https://example.com/spring-tool-suite-3.6.0.RELEASE-e4.4-win32.zip",
                "zip", "323MB", "windows", "32"));
        links.add(new DownloadLink("https://example.com/spring-tool-suite-3.6.0.RELEASE-e4.4-win32-x86_64.zip",
                "zip", "323MB", "windows", "64"));
        links.add(new DownloadLink("https://example.com/spring-tool-suite-3.6.0.RELEASE-e4.4-macosx-cocoa-x86_64.dmg",
                "dmg", "323MB", "mac", "64"));
        links.add(new DownloadLink("https://example.com/spring-tool-suite-3.6.0.RELEASE-e4.4-linux-gtk.tar.gz",
                "tar.gz", "323MB", "linux", "32"));
        links.add(new DownloadLink("https://example.com/spring-tool-suite-3.6.0.RELEASE-e4.4-linux-gtk-x86_64.tar.gz",
    ...
    private ToolSuiteDownloads buildToolSuite() {
        ...
        v36Mac64Links.add(new DownloadLink("https://example.com/spring-tool-suite-3.6.0.RELEASE-e4.4-macosx-cocoa-x86_64.dmg",
        ...
        architecture = "64";
        v35Mac64Links.add(new DownloadLink("https://example.com/spring-tool-suite-3.5.1.RELEASE-e4.3.2-macosx-cocoa-x86_64.tar.gz",
                "tar.gz", "323MB", os, architecture));
        v35Mac64Links.add(new DownloadLink("https://example.com/spring-tool-suite-3.5.1.RELEASE-e4.3.2-macosx-cocoa-x86_64-installer.dmg",
                "dmg", "323MB", os, architecture));
        v35MacArchitectures.add(new Architecture("Mac OS X (Cocoa, 64bit)", v35Mac64Links));

        List<DownloadLink> v35Mac32Links = new ArrayList<>();
        architecture = "32";
        v35Mac32Links.add(new DownloadLink("https://example.com/spring-tool-suite-3.5.1.RELEASE-e4.3.2-macosx-cocoa.tar.gz",
                "tar.gz", "323MB", os, architecture));
        v35Mac32Links.add(new DownloadLink("https://example.com/spring-tool-suite-3.5.1.RELEASE-e4.3.2-macosx-cocoa-installer.dmg",
                "dmg", "323MB", os, architecture));
        ...
        architecture = "32";
        win32Links.add(new DownloadLink("https://example.com/spring-tool-suite-3.6.0.RELEASE-e4.4-win32.zip",
        ...
        architecture = "64";
        win64Links.add(new DownloadLink("https://example.com/spring-tool-suite-3.6.0.RELEASE-e4.4-win32-x86_64.zip",
                "zip", "323MB", os, architecture));
        ...
        architecture = "32";
        linux32Links.add(new DownloadLink("https://example.com/spring-tool-suite-3.6.0.RELEASE-e4.4-linux-gtk.tar.gz",
                "tar.gz", "323MB", os, architecture));
        linux32Links.add(new DownloadLink("https://example.com/linux.sh", "sh", "323MB", os, architecture));
        linuxArchitectures.add(new Architecture("Linux (GTK)", linux32Links));

        List<DownloadLink> linux64Links = new ArrayList<>();
        architecture = "64";
        linux64Links
                .add(new DownloadLink("https://example.com/spring-tool-suite-3.6.0.RELEASE-e4.4-linux-gtk-x86_64.tar.gz",
                        "tar.gz", "323MB", os, architecture));
        ...
        return new ToolSuiteDownloads("ShortName", "3.6.0.RELEASE",
                "https://docs.spring.io/sts/nan/latest/NewAndNoteworthy.html", platforms, archives);
    }
}
